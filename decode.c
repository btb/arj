/*
 * $Id: decode.c,v 1.4 2007/04/20 04:36:46 andrew_belov Exp $
 * ---------------------------------------------------------------------------
...
uint16_t FAR *c_table;
uint16_t FAR *pt_table;
#else
...
#if SFX_LEVEL>=ARJSFXV
static void NEAR make_table(int nchar, unsigned char *bitlen, int tablebits, uint16_t FAR *table, int tablesize)
#else
static void NEAR make_table(int nchar, unsigned char *bitlen, int tablebits, uint16_t *table, int tablesize)
#endif
{
