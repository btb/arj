/*
 * $Id: postproc.c,v 1.7 2007/04/19 20:06:05 andrew_belov Exp $
 * ---------------------------------------------------------------------------
...
static unsigned char integrity_pattern[]={0xB0, 0x03, 0xB0, 0x02, 0xB0, 0x03, 0xB0,
                                 0x04, 0xB0, 0x05, 0};
static uint16_t self_check[]={0x9090, 0x9090, 0x138, 0x9090, 0x9090};
...
int main(int argc, char **argv)
{
 ...
 printf("POSTPROC v 1.30  [17/01/2003]  ARJ helper tool\n\n");
 if(argc<2)
 {
