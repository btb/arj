/*
 * $Id: environ.h,v 1.20 2007/04/19 18:42:09 andrew_belov Exp $
 * ---------------------------------------------------------------------------
...
/* Case sensitivity (under OS/2, this actually depends on the IFS in use!) */
...
struct l_search
{
 struct l_key l_key;
 nlink_t refcount;
 FILE_COUNT ref;                        /* Internal reference to a file */
};
#endif
