/*
 * $Id: externs.h,v 1.8 2007/04/20 04:36:46 andrew_belov Exp $
 * ---------------------------------------------------------------------------
...
extern int have_path_shortcuts;
...
extern uint16_t left[2*NC-1];
extern uint16_t right[2*NC-1];
extern unsigned char c_len[NC];
extern uint16_t cpos;
