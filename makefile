#
# $Id: makefile,v 1.14 2016/05/08 20:00:52 andrew_belov Exp $
# ----------------------------------------------------------------------------
...
!endif
!ifdef LIBC
WCCLIBC = -i=$(LIBCPATH) -D__EXTENDED__ -zl -wcd=138 -D_LNK_CONV=__syscall -D_System=__syscall
!endif
...
NEWLINK = 1
#
# Visual C++ v 2.20 (9.10) / 4.xx (10.xx)
#
!if "$(COMPILER)" == "MSVC"||"$(COMPILER)" == "MSVC20"||"$(COMPILER)" == "MSVC40"
CC_CODE = $(COMPILER)
CC = cl.exe
!ifdef DEBUG
ADD_COPT = /Ge /Zi /Od
